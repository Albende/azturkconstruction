...
function StickyMobileCTA() {
  ...
  return (
    ...
    >
      {/* Glass background */}
      <div className="absolute inset-0 bg-navy-900/95 backdrop-blur-xl border-t border-gold-500/20" />
      ...
      <div className="relative flex">
        ...
        <a
          ...
          className="
            ...
            text-navy-900 font-semibold text-base
        ...
        {/* Divider */}
        <div className="w-[1px] bg-navy-700" />
